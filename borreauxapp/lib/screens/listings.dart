                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children:[
                      ...
                      Divider(color: AppColor.secondaryColor, thickness: 3, indent: 30, endIndent: 30,),
                      ...
                      Row(
                        ...
                        children: [   
                          InkResponse(   
                            ...
                            child: ListingProfilePic("lib/assets/images/blank_profile.png"),
                          )
                        ],
                      ),
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => MessagesWidget(AppColor.secondaryColor),),
                              );
                        }, 
                        child: Text("Message"),
                        style: ButtonStyle(
